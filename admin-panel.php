...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","","h.m.s");
...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      ...
      <a class="navbar-brand" href="#"style= "margin-top: 0px; margin-right: 950px; margin-left: 2%; font-family: 'IBM Plex Sans', sans-serif; "><h5 style="color: white;"><i class="fa fa-user-plus" aria-hidden="true"></i> <b>Test Health Care Hospital</b> </h5></a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:60px;">
    <h3 style = "margin-left: 43%;  padding-bottom: 40px; font-family: 'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo $username ?> </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%;margin-left:2%;  margin-top: 9%">
