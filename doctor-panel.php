...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Test Health Care Hospital </a>
...
<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 39%; padding-bottom: 40px; font-family:'IBM Plex Sans', sans-serif;"> Welcome Dr.&nbsp<?php echo $_SESSION['dname'] ?>! </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%; margin-top: 9%; margin-left:5%;">
