...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
<a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 3%; margin-left: -10%;  font-family: 'IBM Plex Sans', sans-serif; color: red;"><i class="fa fa-user-plus" aria-hidden="true"></i><h3><b> <i> Test Health Care Hospital </i></b></h3></a>
  ...
  <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-8 register-left" style="margin-top: -3%;right: 25%;">
                        <img src="images/project logo.png" alt=""/>
                        <h3><b>Welcome To </b></h3>
                        <span><h2><b style="color:red;">Test Health Care Hospital</b></h2></span>
                        <span><h3><b> Stay safe, Stay healthy</b></h3></span>
                        <span><h5><b>Test Emergency Care</b></h5></span>
                        <span style="color:Black;"><b>IN YOUR TIME OF <i style="color: red">EMERGENCY </i>TRUST IN OUR EXPERTISE</b></span><br/>
                        <span style="color:red;"><b>Call 0627 (Available24/7)</b></span>
                    </div>       
